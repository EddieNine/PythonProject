...
class Historico:
    ...
    def adicionar_transacao(self, transacao, transacao_valor):
...
class Saque(Transacao):
    ...
    def registrar(self, conta):
        ...
        if sucesso_transacao:
            conta.historico.adicionar_transacao(self, self.valor)
...
def criar_contas(numero_conta, cliente, contas):
    cpf = input("Informe o CPF do cliente: ")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("\n@@@ Operação inválido, por favor selecione novamente a operação desejada @@@")
